...
def sidebar():
    ...
    with st.sidebar:
        ...
        st.page_link("pages/update_batas_kuadran.py", label="Batas Kuadran", icon=":material/dataset:")
        st.page_link("pages/tunggakan_am.py", label="Tunggakan AM", icon=":material/dataset:")
